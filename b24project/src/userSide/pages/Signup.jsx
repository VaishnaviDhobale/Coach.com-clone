  ...
  export default function Signup() {
    ...
    const handleSubmit = async () => {
      ...
      if(!email.includes("@gmail.com")){
        toast({
          title: "Please check your email or contact",
      ...
      try {
        setIsLoading(true);
        let res = await fetch(
          "https://ruby-defiant-caridea.cyclic.app/user/addUser",
          {
            method: "POST",
            headers: {
          ...
          <Stack spacing={2} mt={"12px"}>
            ...
            <Stack spacing={5} pt={2}>
              <Text fontSize="xs">
                ...
                automated security notifications via text message from Bagiose.
