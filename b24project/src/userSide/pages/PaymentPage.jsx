...
const PaymentPage = () => {
  ...
  console.log("chekcoutcart", cartData);
  ...
  return (
    ...
    <Navbar />
      ...
      >
        <Text textAlign="center" fontSize="3xl" mb= "30px">
          Checkout
        </Text>
      </Box>
      <Link to={"/cart"} mt="50px">
        {" "}
              ...
              <h2>
                <AccordionButton>
                  <Box flex="1" textAlign="left">
                    <Text fontSize="xl" fontWeight={"bold"} color={"#b266ff"}>
